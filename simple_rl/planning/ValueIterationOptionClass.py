...
class ValueIteration(Planner):
    ...
    def __init__(self, mdp, name="value_iter", delta=0.0001, max_iterations=500, sample_rate=3, point_options=[]):
        '''
        Args:
            mdp (MDP)
    ...
    def run_vi(self):
        iterations, value_of_init_state, _ = self.run_vi_hist()
        return iterations, value_of_init_state
        
    def run_vi_hist(self):
        '''
        Summary:
        ...
        return iterations, value_of_init_state, max_diff_hist
