...
def run_single_agent_on_mdp(agent, mdp, episodes, steps, experiment=None, verbose=False, track_disc_reward=False, reset_at_terminal=False, resample_at_terminal=False):
    ...
    for episode in range(1, episodes + 1):
        ...
        for step in range(1, steps + 1):
            # TODO: Test if the state is correctly applied.
            # print('state=', state)
            ...
            # print('reward, next_state=', reward, next_state)
            ...
            if experiment is not None:
                reward_to_track = mdp.get_gamma()**(step + 1) * reward if track_disc_reward else reward
